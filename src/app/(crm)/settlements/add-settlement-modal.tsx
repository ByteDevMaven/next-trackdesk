...
export function AddSettlementModal({ user, ticketId, isOpen, onClose, onSuccess }: AddSettlementModalProps) {
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="assignee" value={user.name} disabled />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="space-y-4">
                                {items.map((item) => (
                                    <div
                                        key={item.id}
                                        className="grid grid-cols-1 gap-4 p-4 border rounded-md sm:grid-cols-2 md:grid-cols-3"
                                    >
                                        <div className="space-y-2">
